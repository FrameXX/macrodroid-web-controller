...
export const ACTIONS: Action[] = [
  ...
  {
    id: "start_recording_microphone",
    name: "Start recording microphone",
    iconId: "microphone",
    args: [
      {
        name: "Source",
        value: 0,
        type: ActionArgType.Selection,
        options: ["Standard microphone", "Camcorder", "Unprocessed"],
        id: "source",
      },
      {
  ...
  },
  {
    ...
    name: "Stop recording microphone",
    iconId: "microphone-off",
    args: [],
    keywords: ["record", "capture", "audio", "microphone", "camcorder"],
  },
  {
    ...
    args: [
      {
        ...
        value: 0,
        type: ActionArgType.Selection,
        options: ["Front facing", "Rear facing"],
        id: "camera",
      },
      {
        name: "Flash",
        ...
        id: "flash",
        useCondition: { argIndex: 0, argValue: 1 },
      },
      {
  ...
  },
  {
    ...
    keywords: ["volume", "set", "audio", "speaker", "loudness", "music"],
  },
] as const;
